 ...
 * Propagation de la chaleur selon l'axe x.
 * */
void diffuser_chaleur_x_ij(MAT m1, MAT m2, int i_in, int i_fi, int j_in, int j_fi, int taille) {
    int i;
    for(i = i_in; i < i_fi; i++) {
        int j;
        for(j = j_in; j < j_fi; j++) {
 ...
 * Propagation de la chaleur selon l'axe y.
 * */
void diffuser_chaleur_y_ij(MAT m1, MAT m2, int i_in, int i_fi, int j_in, int j_fi, int taille) {
    int j;
    for(j = j_in; j < j_fi; j++) {
        int i;
        for(i = i_in; i < i_fi; i++) {
